...
<div class="tools-container">
    <div class="home-max-width max-content-container">
        ...
        <span class="title-text1">Random English Word</span>
    <div class="containers_center width60">
        <p><span class = "font18"> Click the button below to generate a random english word:</span></p>
        <form class = "font20 form_class1 noborder">
            ...
            <select class = "font20" id="target-language">
                ...
                <option value="zh" selected>Chinese(Simp)</option>
		...
		<form class = "text_end" id="word-form">
			...
			<input class = "right font18" type="number" id="min-rank" name="min-rank" min="1" max="333333" value="1" required><br>
			<label class = "left font18" for="max-rank">Maximum Rank:</label>
			<input class = "right font18" type="number" id="max-rank" name="max-rank" min="1" max="333333" value="10000" required>
		</form>
		<p></p>
		...
		<div class ="ref-container" id="reference">
			<p><b>Reference: </b><br>
				The english word frequency list is from <a class = "href-link" href='https://www.kaggle.com/datasets/rtatman/english-word-frequency'>https://www.kaggle.com/datasets/rtatman/english-word-frequency</a>.<br>
				...
				Note: The translate sometimes is not so accurate, better to go to dictionaries for more information.
			</p>
		</div>
    </div>
</div>
<script src="{{ site.baseurl }}/assets/js/mytools/random_english_word.js"></script>